...
(function(factory) {
    ...
    var obsolete = function(f, oldName, newName) {
        var wrapper = function() {
            console.warn("gridstack.js: Function `" +
                oldName +
    ...
    var obsoleteOpts = function(oldName, newName) {
        console.warn("gridstack.js: Option `" +
            oldName +
    ...
    */
    ...
    GridStackEngine.prototype.isAreaEmpty = function(x, y, width, height) {
        ...
        var collisionNode = _.find(this.nodes,
            _.bind(function(n) {
    ...
    GridStackEngine.prototype.canMoveNode = function(node, x, y, width, height) {
        ...
        if (hasLocked) {
            res &= !Boolean(_.find(clone.nodes,
                function(n) {
    ...
    var GridStack = function(el, opts) {
        ...
        this.grid = new GridStackEngine(this.opts.width,
                ...
                .droppable(self.container,
                    {
                        accept: function(el) {
                            ...
                            return el.is(
                                self.opts.acceptWidgets === true ? ".grid-stack-item" : self.opts.acceptWidgets);
                        }
                    })
                .on(self.container,
                    "dropover",
    ...
    GridStack.prototype._prepareElementsByNode = function(el, node) {
        ...
        var dragOrResize = function(event, ui) {
            ...
            (node.lastTriedX === x &&
                ...
                node.lastTriedHeight === lastTriedHeight)) {
                return;
            }
            node.lastTriedX = x;
            node.lastTriedY = y;
    ...
    GridStack.prototype.addWidget = function(el,
        x,
        y,
        width,
        height,
