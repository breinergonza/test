        ...
        reverseHeaders.each(function() {
            ...
            if (html !== "") {
                if (hierarchyClass) {
                    ...
                    $cells.filter(filter)
                        .prepend("<b class='" + classes.cellLabels + hierarchyClass + "'>" + html + "</b>");
                } else {
        ...
        $table
                    ...
                    $(this)
                        .bind("touchmove",
                            function(e) {
                                ...
                                if (Math.abs(x - originX) > cfg.horizontalThreshold &&
            ...
            .bind("tablesawcolumns.swipetoggle",
                function() {
                    ...
                    $prevBtn.closest("." + classes.toolbar)[!canGoPrev && !canGoNext ? "addClass" : "removeClass"](
        ...
        methods = {
            ...
            sortRows: function(rows, colNum, ascending, col) {
                ...
                var getCells = function(rows) {
                    ...
                    getSortFxn = function(ascending, forceNumeric) {
                        ...
                        if (ascending) {
                            fn = function(a, b) {
                                if (forceNumeric) {
                                    return parseFloat(a.cell.replace(regex, "")) -
                            ...
                            fn = function(a, b) {
                                if (forceNumeric) {
                                    return parseFloat(b.cell.replace(regex, "")) -
                ...
                fn = (customFn && typeof customFn === "function" ? customFn(ascending) : false) ||
                    getSortFxn(ascending,
                        $(col).is("[data-sortable-numeric]") && !$(col).is('[data-sortable-numeric="false"]'));
