(function($, moment) {
    ...
    Plugin.prototype =
    {
            ...
            if (this.$element.val().length > 0) {
                ...
                if (typeof (this.$element.attr("value")) !== "undefined" &&
                    ...
                    if (typeof (this.$element.attr("value")) === "string") {
                        if (typeof (this.params.format) !== "undefined" && this.params.format !== null) {
                            this.currentDate = moment(this.$element.attr("value"), this.params.format)
                    ...
                    if (typeof (this.params.currentDate) !== "undefined" && this.params.currentDate !== null) {
                        if (typeof (this.params.currentDate) === "string") {
                            if (typeof (this.params.format) !== "undefined" && this.params.format !== null) {
                                this.currentDate = moment(this.params.currentDate, this.params.format)
                                    .locale(this.params.lang);
                            } else {
        ...
        initButtons: function() {
            ...
            this._attachEvent(this.$dtpElement.find("a.dtp-select-month-before"),
                "click",
                this._onMonthBeforeClick.bind(this));
            this._attachEvent(this.$dtpElement.find("a.dtp-select-month-after"),
                "click",
                this._onMonthAfterClick.bind(this));
            this._attachEvent(this.$dtpElement.find("a.dtp-select-year-before"),
                "click",
            ...
            this._attachEvent(this.$dtpElement.find("a.dtp-select-year-range.before"),
                "click",
                this._onYearRangeBeforeClick.bind(this));
            this._attachEvent(this.$dtpElement.find("a.dtp-select-year-range.after"),
                "click",
        ...
        initDate: function(d) {
            ...
            var _date = ((typeof (this.currentDate) !== "undefined" && this.currentDate !== null)
                ? this.currentDate
                : null);
        ...
        createSVGClock: function(isHour) {
            ...
            var svgClockFace = this.createSVGElement("circle",
                { r: "192", fill: "#eee", stroke: "#bdbdbd", 'stroke-width': 2 });
            ...
            if (isHour) {
                var svgMinuteHand = this.createSVGElement("line",
                    { class: "minute-hand", x1: 0, y1: 0, x2: 0, y2: -150, stroke: "#bdbdbd", 'stroke-width': 2 });
                var svgHourHand = this.createSVGElement("line",
                    { class: "hour-hand", x1: 0, y1: 0, x2: 0, y2: hl, stroke: "#26c6da", 'stroke-width': 8 });

                svgGElement.appendChild(svgMinuteHand);
                svgGElement.appendChild(svgHourHand);
            } else {
                var svgMinuteHand = this.createSVGElement("line",
                    { class: "minute-hand", x1: 0, y1: 0, x2: 0, y2: -150, stroke: "#26c6da", 'stroke-width': 2 });
                var svgHourHand = this.createSVGElement("line",
                    { class: "hour-hand", x1: 0, y1: 0, x2: 0, y2: hl, stroke: "#bdbdbd", 'stroke-width': 8 });
        ...
        showDate: function(date) {
            if (date) {
                ...
                this.$dtpElement.find(".dtp-actual-month")
        ...
        showTime: function(date) {
            if (date) {
                ...
                var content = ((this.params.shortTime) ? date.format("hh") : date.format("HH")) +
                    ":" +
            ...
            for (var i = 0; i < calendar.days.length; i++) {
                ...
                if (calendar.days[i] != 0) {
                    if (this.isBeforeMaxDate(moment(calendar.days[i]), false, false) === false ||
                        ...
                        if (moment(calendar.days[i]).locale(this.params.lang).format("DD") ===
        ...
        toggleTime: function(value, isHours) {
            ...
            if (isHours) {
                ...
                result = !(this.isAfterMinDate(_date, true, false) === false ||
                    this.isBeforeMaxDate(_date, true, false) === false);
            } else {
                var _date = moment(this.currentDate);
                _date.minute(value).second(0);

                result = !(this.isAfterMinDate(_date, true, true) === false ||
        ...
        _centerBox: function() {
            ...
            this.$dtpElement.find(".dtp-content")
                .css("marginLeft", -(this.$dtpElement.find(".dtp-content").width() / 2) + "px");
