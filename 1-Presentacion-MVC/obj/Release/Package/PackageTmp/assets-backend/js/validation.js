    ...
    var defaults = {
        ...
        methods: {
            init: function(options) {
                ...
                $(uniqueForms).bind("submit.validationSubmit",
                    function(e) {
                        var $form = $(this);
                        var warningsFound = 0;
                        var $allInputs = $form.find("input,textarea,select").not("[type=submit],[type=image]")
                        ...
                        if (warningsFound) {
                            ...
                            if ($.isFunction(settings.options.submitError)) {
                                settings.options.submitError($form,
                                    e,
                                    $inputsWithValidators.jqBootstrapValidation("collectErrors", true));
                            }
                        } else {
                ...
                return this.each(function() {
                                    ...
                                    $.each(settings.validatorTypes,
                                        function(validatorTemplateType, validatorTemplate) {
                                            ...
                                            if (!foundValidator &&
                                                ...
                                                validators[validatorType].push($.extend(validator,
                    ...
                    $this.bind("getValidatorCount.validation",
                        function() {
                    ...
                    $this.bind(
                        ...
                        .concat(["revalidate"]).join(".validation ") +
                        ".validation",
                        function(e, params) {
                            var value = getValue($this);
                            var errorsFound = [];
                            ...
                            if (errorsFound.length) {
                                $controlGroup.removeClass("validate error issue")
            ...
            hasErrors: function() {
                ...
                this.find("input,select,textarea").add(this).each(function(i, el) {
                    errorMessages = errorMessages.concat($(el).triggerHandler("getValidators.validation")
        ...
        validatorTypes: {
            callback: {
                ...
                validate: function($this, value, validator) {
                    ...
                    if (validator.lastFinished === true) {
                        ...
                        var rrjqbvThis = $this;
                        executeFunctionByName(validator.callback,
                            window,
                            $this,
                            value,
                            function(data) {
            ...
            email: {
                ...
                init: function($this, name) {
                    var result = {};
                    result.regex =
                        regexFromString("[a-zA-Z0-9.!#$%&\u2019*+/=?^_`{|}~-]+@[A-Za-z0-9.-]+\\.[A-Za-z]{2,4}");
            ...
            maxchecked: {
                ...
                init: function($this, name) {
                    ...
                    elements.bind("change.validation click.validation",
                        function() {
                            $this.trigger("revalidate.validation",
                                {
                                    includeEmpty: true
